...
LangString DESC_SEC_DOTNET ${LANG_FRENCH} "Télécharger et installer les runtimes .NET 2.0 s'ils ne sont pas déjà installés."
LangString DESC_SEC_SERVICE ${LANG_FRENCH} "Installer et démarrer automatiquement le service OpenVPN Manager."
